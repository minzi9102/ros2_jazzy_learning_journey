...
def launch_setup(context):
    ...
    moveit_config = (
        ...
        .moveit_cpp(
            file_path=get_package_share_directory("ur_moveit_cpp")#<- 可以修改为FindPackageShare
    ...
    name="rviz2",
    output="log",
    arguments=["-d", get_package_share_directory("ur_moveit_cpp") + "/config/moveit_cpp_tutorial.rviz"],
    parameters=[
